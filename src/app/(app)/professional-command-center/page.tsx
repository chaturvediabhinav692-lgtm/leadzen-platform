...
export default function ProfessionalCommandCenter() {
        ...
        <RouteGuard>
            <div className="max-w-7xl mx-auto p-4 md:p-8 space-y-8 pb-20">
                ...
                <div className="flex justify-between items-end">
                    ...
                    <Link href="/professional-dashboard" className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg font-bold flex items-center gap-2 transition-colors shadow-sm">
                        ...
                        {topTasks.map(client => (
                            <div key={client.id} className="p-4 hover:bg-slate-50 flex flex-col md:flex-row md:items-center justify-between gap-4 transition-colors">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <Link href={`/professional-dashboard`} className="p-2 text-slate-400 hover:text-slate-600 hover:bg-slate-100 rounded-lg transition-colors" title="View in Cockpit">
                                        <ArrowRight size={18} />
                                    </Link>
                                </div>
                            </div>
