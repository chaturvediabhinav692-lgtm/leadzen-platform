...
import LiveActionBar from '@/components/professional-execution/LiveActionBar';
import HeroClient from '@/components/professional-execution/HeroClient';
import ActionStream from '@/components/professional-execution/ActionStream';
import SmartInsights from '@/components/professional-execution/SmartInsights';
import QuickActions from '@/components/professional-execution/QuickActions';
...
export default function ProfessionalDashboardPage() {
    ...
    return (
        <RouteGuard>
            <div className="min-h-screen bg-[#0b0c10] pb-40 font-body">
                {isLoading ? (
                    <div className="flex items-center justify-center h-[80vh]">
                        <div className="w-12 h-12 border-4 border-white/5 border-t-accent rounded-full animate-spin"></div>
                    </div>
                ) : (
                    <>
                        {toastMessage && (
                            <div className="fixed top-24 right-6 bg-accent/90 text-white px-6 py-3 rounded-2xl shadow-glow text-sm font-semibold z-[100] backdrop-blur-xl border border-white/20 animate-in fade-in slide-in-from-top-4 duration-300">
                                {toastMessage}
                            </div>
                        )}
                        ...
                        <div className="max-w-7xl mx-auto px-6 space-y-8 mt-8">
                            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                                <div className="lg:col-span-2 space-y-8">
                                    ...
                                    />
                                    <div className="bg-[#111217] p-8 rounded-2xl border border-white/5 group hover:border-white/10 transition-all">
