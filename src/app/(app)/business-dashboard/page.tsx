...
import Metrics from '@/components/business-dashboard/Metrics';
import HotLeads from '@/components/business-dashboard/HotLeads';
import RecentActivity from '@/components/business-dashboard/RecentActivity';
import ProfessionalPerformance from '@/components/business-dashboard/ProfessionalPerformance';
    ...
    return (
        <RouteGuard>
            <div className="max-w-7xl mx-auto space-y-8 p-6">
                ...
                <ProfessionalPerformance clients={leads} />
            </div>
        </RouteGuard>
    );
}
