        ...
        <div className="min-h-screen bg-black flex items-center justify-center p-6 selection:bg-purple-500/30">
            ...
            >
                <div className="text-center mb-12">
                    <div className="w-12 h-12 bg-gradient-to-tr from-purple-600 to-blue-600 rounded-xl mx-auto mb-6 shadow-xl shadow-purple-500/20" />
                    <h1 className="text-3xl font-black text-white tracking-tighter mb-2">Access {product}</h1>
                    <p className="text-slate-500 font-medium">Choose your workspace to continue</p>
                </div>
